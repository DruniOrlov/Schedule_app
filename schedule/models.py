...
class Lesson(models.Model):
    ...
    class Meta:
        unique_together = [['begin', 'end', 'tutor'],
                           ['begin', 'end', 'group'],
                           ['tutor', 'group', 'begin', 'end'],
                           ['group', 'auditorium', 'begin', 'end'],
                           ['number', 'group', 'begin', 'end'],
                           ['number', 'tutor', 'begin', 'end'],
                           ['begin', 'end', 'tutor', 'group', 'auditorium', 'number']]
